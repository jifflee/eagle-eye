...
```bash
./scripts/milestone-audit-data.sh [milestone_name]
```

Returns JSON: milestone metadata, counts, issues with details, orphans.
...
**User action:** Run `/milestone-update` manually to apply recommended changes
