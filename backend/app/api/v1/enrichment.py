...
AVAILABLE_CONNECTORS: list[SourceListItem] = [
    ...
    SourceListItem(name="openfec", tier=1, requires_auth=False, description="OpenFEC — campaign contributions", status="available"),
    SourceListItem(name="usaspending", tier=1, requires_auth=False, description="USASpending — federal contracts", status="available"),
    SourceListItem(name="propublica_nonprofit", tier=1, requires_auth=False, description="ProPublica — nonprofit orgs", status="available"),
    SourceListItem(name="fdic_bankfind", tier=1, requires_auth=False, description="FDIC — bank branches", status="available"),
    SourceListItem(name="overpass_osm", tier=1, requires_auth=False, description="OSM Overpass — nearby POIs", status="available"),
    SourceListItem(name="wayback", tier=1, requires_auth=False, description="Wayback Machine — archived sites", status="available"),
    SourceListItem(name="fcc_license", tier=1, requires_auth=False, description="FCC — broadcast/wireless licenses", status="available"),
    SourceListItem(name="uspto_trademark", tier=1, requires_auth=False, description="USPTO — trademarks/patents", status="available"),
